...
type WordCloudChartsWithPlayer[X xconstraints.ValidType, Y xconstraints.Numeric] struct {
...
func NewWordCloudChartsGraphWithPlayer[X xconstraints.ValidType, Y xconstraints.Numeric]() *WordCloudChartsWithPlayer[X, Y] {
