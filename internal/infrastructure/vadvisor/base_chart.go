...
type PlayerConfig[X xconstraints.ValidType, Y xconstraints.Numeric] struct {
	Auto      bool           `json:"auto"`
	Loop      bool           `json:"loop"`
...
type Specs[X xconstraints.ValidType, Y xconstraints.Numeric] struct {
	Data *DataUnit[X, Y] `json:"data,omitempty"`
}

type DataUnit[X xconstraints.ValidType, Y xconstraints.Numeric] struct {
	ID     string             `json:"id"`
...
type ValueUnit[X xconstraints.ValidType, Y xconstraints.Numeric] struct {
...
type Value[Y xconstraints.Numeric] struct {
	YAxis       Y
	SeriesField string
}

func NewBaseChartsGraph[X xconstraints.ValidType, Y xconstraints.Numeric]() *BaseChartsGraphWithPlayer[X, Y] {
