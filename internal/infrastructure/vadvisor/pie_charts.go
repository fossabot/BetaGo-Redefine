...
type PieChartsGraphWithPlayer[X xconstraints.ValidType, Y xconstraints.Numeric] struct {
...
func NewPieChartsGraphWithPlayer[X xconstraints.ValidType, Y xconstraints.Numeric]() *PieChartsGraphWithPlayer[X, Y] {
