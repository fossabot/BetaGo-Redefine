...
type BarChartsGraphWithPlayer[X xconstraints.ValidType, Y xconstraints.Numeric] struct {
...
func NewBarChartsGraphWithPlayer[X xconstraints.ValidType, Y xconstraints.Numeric]() *BarChartsGraphWithPlayer[X, Y] {
